...
public class StableSpringQuad {
     ...
     * the positions are stored as reference which means that if you change either
     * of the vectors afterwards it will also change the position of the connected
     * particles.
     *
