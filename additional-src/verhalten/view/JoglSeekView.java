...
/*
 * visualize the output of the 'seek' behavior.
 */
...
public class JoglSeekView
    implements IBehaviorView {

    private Seek _myBehavior;

    public JoglSeekView(Seek theBehavior) {
    ...
    public void draw(GLContext theRenderContext, IVerhaltenEntity theEntity) {
        ...
        Vector3f myColor = Verhalten.DEBUG_COLOR_SEEK;
